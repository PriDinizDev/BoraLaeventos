        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConteudoPassoApasso = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LinkGovernoOficial = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsContaAtivada = table.Column<bool>(type: "bit", nullable: false),
